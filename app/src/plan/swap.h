...
parser_error_t swap_getItem(const parser_context_t *ctx, const swap_plan_t *swap, uint8_t actionIdx, char *outKey, uint16_t outKeyLen, char *outVal, uint16_t outValLen, uint8_t pageIdx, uint8_t *pageCount);
